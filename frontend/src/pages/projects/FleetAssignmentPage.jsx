  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-xs text-gray-500 mt-0.5">Vehicles assigned to this project — manage assignments in <span className="font-medium">Fleet → Vehicles → Fleet Assignment</span></p>
      </div>
