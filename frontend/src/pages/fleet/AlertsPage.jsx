...
const ALLOWED_TYPES = [
  'fuel_fill', 'fuel_drain', 'low_fuel',
  'service_due', 'maintenance_due',
  'insurance_expiry', 'inspection_expiry', 'speed_governor_expiry',
  'speeding', 'sos', 'idle_long', 'ignition_off_moving', 'device_offline',
  'geofence', 'compliance_issue',
]
...
const TYPE_GROUP = {
  fuel_fill: 'Fuel', fuel_drain: 'Fuel', low_fuel: 'Fuel',
  service_due: 'Maintenance', maintenance_due: 'Maintenance',
  insurance_expiry: 'Compliance', inspection_expiry: 'Compliance',
  speed_governor_expiry: 'Compliance', compliance_issue: 'Compliance',
  speeding: 'Safety', sos: 'Safety', idle_long: 'Safety',
  ignition_off_moving: 'Safety', device_offline: 'Safety', geofence: 'Safety',
}
