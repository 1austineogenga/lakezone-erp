  ...
  return (
    <div className="mb-6">
      ...
      <table className="w-full text-sm">
        <tbody>
          {rows.length === 0 && (
            <tr><td colSpan={3} className="px-4 py-3 text-gray-400 italic text-xs">No entries</td></tr>
          )}
          {rows.map((r, i) => (
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Financial position as of a specific date</p>
        </div>
